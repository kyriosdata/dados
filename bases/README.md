...
- **Codigo_Nacional_Atualizado.csv** contém códigos dos 5570 municípios do Brasil, com o estado correspondente, município, Código do unicípio;Código nacional e faixa com início e fim do CEP correspondente a cada município. ([wiki](https://pt.wikipedia.org/wiki/C%C3%B3digo_de_Endere%C3%A7amento_Postal))([MBI](https://www.mbi.com.br/mbi/biblioteca/utilidades/dddcepsp/))
